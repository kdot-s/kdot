...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kdots Store — premium Rainbow Six Siege scripts, macros" },
      { property: "og:title", content: "Kdots Store — Premium Siege Scripts" },
      { property: "og:description", content: "Kdots Store — premium Rainbow Six Siege scripts, macros" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Kdots Store — Premium Siege Scripts" },
      { name: "twitter:description", content: "Kdots Store — premium Rainbow Six Siege scripts, macros" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/96be2be0-a578-49f9-8c5e-ff97a4f750f0" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/96be2be0-a578-49f9-8c5e-ff97a4f750f0" },
